  ...
  planner: {
    ...
    steps: [
      ...
      },
      {
        target: "planner-plan",
        title: "Your plan",
        body: "See what's happening today and what's coming up.",
        placement: "top",
      },
      {
      ...
      },
      {
        ...
        body: "Review what Duncan has done and make changes whenever you need. Connection and filters live here.",
        placement: "bottom",
      },
    ],
  },
