...
export function RichNoteEditor({ value, onChange, placeholder }: Props) {
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm dark:prose-invert max-w-none focus:outline-none min-h-full px-6 py-4 leading-7 [&_ul[data-type=taskList]]:list-none [&_ul[data-type=taskList]_p]:m-0 [&_ul[data-type=taskList]_li]:flex [&_ul[data-type=taskList]_li]:gap-2 [&_ul[data-type=taskList]_li>label]:mt-1.5",
      },
    },
