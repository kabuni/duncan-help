...
import { Loader2, Send, Sparkles, Mail, Inbox, CheckCircle2, Circle, XCircle, MessageSquare } from "lucide-react";
                ...
                return (
                  <li key={r.id}>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mt-1 pl-5.5">
